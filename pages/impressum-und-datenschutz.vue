...
<template>
  <div>
    ...
    />
    <div class="content">
      <h2 class="heading-thank-you">Herzlichen Dank</h2>
      <p class="u-margin-bottom-xs">für die äußerst engagierte und kreative Umsetzung meiner Wünsche:</p>
      <p class="u-margin-bottom-xxs">
        <a href="https://pascalchorus.de" target="_blank" rel="noopener">Pascal Chorus</a> und Nora Rigo (Website)
      </p>
      <p class="u-margin-bottom-xl">Kim Laubkermeier und Jenny Kostyal (Fotografie)</p>
      ...
      <div class="u-text-block">
        ...
        <h3>Vertretungs&shy;berechtigt</h3>
        <p>Mirka Carlsen</p>

        <h3>Registergericht&shy;seintrag</h3>
        ...
        <p>
          ...
          <strong class="adsimple-311879228">Kurz gesagt:</strong> Wir informieren Sie umfassend über Daten, die wir
        ...
        <ol>
          <li class="adsimple-311879228">
            <strong class="adsimple-311879228">Einwilligung</strong> (Artikel 6 Absatz 1 lit. a DSGVO): Sie haben uns
          ...
          <li class="adsimple-311879228">
            <strong class="adsimple-311879228">Berechtigte Interessen</strong> (Artikel 6 Absatz 1 lit. f DSGVO): Im
        ...
        <ul class="adsimple-311879228">
          ...
          <li class="adsimple-311879228">
            ...
            Kommunikation in einem professionellen Rahmen betreiben. Dazu sind gewisse technische Einrichtungen wie z.
            B. E-Mail-Programme, Exchange-Server und Mobilfunkbetreiber notwendig, um die Kommunikation effizient
            betreiben zu können.
          </li>
        </ul>
        ...
        <p>
          <strong class="adsimple-311879228">Zielorientierte Cookies<br /> </strong>Diese Cookies sorgen für eine
          bessere Nutzerfreundlichkeit. Beispielsweise werden eingegebene Standorte, Schriftgrößen oder Formulardaten
          gespeichert.
        </p>
        <p>
          <strong class="adsimple-311879228">Werbe-Cookies<br /> </strong>Diese Cookies werden auch Targeting-Cookies
          genannt. Sie dienen dazu dem User individuell angepasste Werbung zu liefern. Das kann sehr praktisch, aber
        ...
        <p>
          ...
          dieser hier). Mit Domain meinen wir zum Beispiel beispiel.de oder musterbeispiel.com.
        </p>
        <p>
        ...
        <p>
          ...
          damit für eine verlässliche und fehlerfreie Speicherung der Daten von Websites.
        </p>
        <p>
        ...
        <p>
          ...
          Sentry, bei der Verarbeitung Ihrer relevanten Daten, das europäische Datenschutzniveau einzuhalten, selbst
          wenn die Daten in den USA gespeichert, verarbeitet und verwaltet werden. Diese Klauseln basieren auf einem
        ...
        <p>
          ...
          kann aber auch vorkommen, dass wir Sie etwa um Ihre Anrede und Ihren Namen bitten, damit wir Sie auch
        ...
        <p>
          ...
          Nachdem Sie sich für unseren Newsletter auf unserer Website angemeldet haben, bekommen Sie eine E-Mail, über
          die Sie die Newsletter-Anmeldung bestätigen. So wird sichergestellt, dass Ihnen die E-Mail-Adresse gehört und
          sich niemand mit einer fremden E-Mail-Adresse angemeldet hat. Wir oder ein von uns verwendetes
          Benachrichtigungs-Tool protokolliert jede einzelne Anmeldung. Dies ist nötig, damit wir den rechtlich
          korrekten Anmeldevorgang auch nachweisen können. Dabei wird in der Regel der Zeitpunkt der Anmeldung, der
          Zeitpunkt der Anmeldebestätigung und Ihre IP-Adresse gespeichert. Zusätzlich wird auch protokolliert, wenn Sie
        ...
        <p>
          ...
          sich damit einverstanden erklären oder es gesetzlich erlaubt ist, schicken wir Ihnen Newsletter,
          System-E-Mails oder andere Benachrichtigungen per E-Mail. Wenn wir im folgenden Text den Begriff „Newsletter“
          verwenden, meinen wir damit hauptsächlich regelmäßig versandte E-Mails. Natürlich wollen wir Sie mit unseren
          Newsletter in keiner Weise belästigen. Darum sind wir wirklich stets bemüht, nur relevante und interessante
          Inhalte zu bieten. So erfahren Sie etwa mehr über unser Unternehmen, unsere Leistungen oder Produkte. Da wir
          unsere Angebote auch immer verbessern, erfahren Sie über unseren Newsletter auch immer, wenn es Neuigkeiten
          gibt oder wir gerade spezielle, lukrative Aktionen anbieten. Sofern wir einen Dienstleister, der ein
          professionelles Versand-Tool anbietet, für unser E-Mail-Marketing beauftragen, machen wir das, um Ihnen
          schnelle und sichere Newsletter bieten zu können. Zweck unseres E-Mail-Marketings ist grundsätzlich, Sie über
          neue Angebote zu informieren und auch unseren unternehmerischen Zielen näher zu kommen.
        </p>
        <h4 class="adsimple-311879228">Welche Daten werden verarbeitet?</h4>
        <p>
        ...
        <p>
          Wenn Sie allerdings bestätigen, dass Sie uns die Einwilligung zur Newsletter-Anmeldung gegeben haben, können
          Sie jederzeit einen individuellen Löschantrag stellen. Widersprechen Sie der Einwilligung dauerhaft, behalten
          wir uns das Recht vor, Ihre E-Mail-Adresse in einer Sperrliste zu speichern. Solange Sie freiwillig unseren
        ...
        <p>
          ...
          kündigen. Wenn der Link im Newsletter wirklich nicht zu finden ist, kontaktieren Sie uns bitte per Mail und
          wir werden Ihr Newsletter-Abo unverzüglich kündigen.
        </p>
        <h4 class="adsimple-311879228">Rechtsgrundlage</h4>
        <p>
          Das Versenden unseres Newsletters erfolgt auf Grundlage Ihrer
          <strong class="adsimple-311879228">Einwilligung</strong> (Artikel 6 Abs. 1 lit. a DSGVO). Das heißt, wir
          dürfen Ihnen nur dann einen Newsletter schicken, wenn Sie sich zuvor aktiv dafür angemeldet haben.
          Gegebenenfalls können wir Ihnen auch Werbenachrichten auf Grundlage des § 7 Abs. 3 UWG senden, sofern Sie
          unser Kunde geworden sind und der Verwendung ihrer E-Mailadresse für Direktwerbung nicht widersprochen haben.
        </p>
        <p>
          Informationen zu speziellen E-Mail-Marketing Diensten und wie diese personenbezogene Daten verarbeiten,
        ...
        <p>
          Wir nutzen auf unserer Website ein sogenanntes Content Delivery Network. Meistens wird ein solchen Netzwerk
        ...
        <p>
          ...
          ausgeliefert werden. Die Datenübertragung zu Ihrem Browser wird folglich durch das CDN deutlich verkürzt.
        </p>
        <h4 class="adsimple-311879228">Warum verwenden wir ein Content Delivery Network für unsere Website?</h4>
        <p>
          Eine schnell ladende Website ist Teil unserer Dienstleistung. Wir wissen natürlich, wie nervig es ist, wenn
        ...
        <h4 class="adsimple-311879228">Welche Daten werden verarbeitet?</h4>
        <p>
          Wenn Sie eine Website bzw. die Inhalte einer Website anfordern und diese in einem CDN zwischengespeichert
          ...
          WordPress-Plugins geladen werden, wenn diese auf
          ...
          senden. Dabei handelt es sich etwa um Daten wie IP-Adresse, Browsertyp, Browserversion, welche Webseite
          geladen wird oder Uhrzeit und Datum des Seitenbesuchs. Diese Daten werden vom CDN gesammelt und auch
          gespeichert. Ob zur Datenspeicherung Cookies verwendet werden, hängt von dem eingesetzten Network ab. Bitte
        ...
        <p>
          ...
          die Verarbeitung personenbezogener Daten, wie sie bei der Erfassung durch ein Content Delivery Network
          vorkommen kann, dar.
        </p>
        <p>
          Von unserer Seite besteht zudem ein berechtigtes Interesse, ein Content Delivery Network zu verwenden, um
          unser Online-Service zu optimieren und sicherer zu machen. Die dafür entsprechende Rechtsgrundlage ist
          <strong class="adsimple-311879228">Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen)</strong>. Wir setzen
        ...
        <p>
          ...
          <a class="adsimple-311879228" href="https://de.wikipedia.org/wiki/Google_LLC?tid=311879228">Google</a>
